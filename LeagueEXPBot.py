...
import os
#load me into tft matches all night     if pyautogui.locateOnScreen('/Users/max/Desktop/ROTMGBot#1/notread.png', confidence = 0.75) != None:
...
def clickAndComment(): #This is for the bad computer
    ...
    loop = True
    while loop:
        newVid = pyA.locateOnScreen('/Users/jniu1/OneDrive/Documents/tftBot/badvideo3.PNG')
        if newVid != None: #!=
            pyA.hotkey('ctrl', 'r') 
            ...
            time.sleep(4)
            commentBox = pyA.locateOnScreen('/Users/jniu1/OneDrive/Documents/tftBot/commentBox2.PNG', confidence = 0.55)
            if commentBox != None:
            ...
            commentSub = pyA.locateOnScreen('/Users/jniu1/OneDrive/Documents/tftBot/commentSubmit2.PNG', confidence = 0.75)
            if commentSub != None:
